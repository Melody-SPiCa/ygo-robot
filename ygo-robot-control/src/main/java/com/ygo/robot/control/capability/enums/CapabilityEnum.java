...
public enum CapabilityEnum {
  ...
  指令_查卡(
      2010, "只在这个 bot 在检索阶段才有1次（同一时间段内只有1个人可以使用并处理这个指令），宣言1个卡名才能发动。把百鸽数据库中1张宣言的卡的检索结果给对方观看。", null),
  指令_查裁定(2011, "宣言1个卡名才能发动。把百鸽数据库中1张宣言的卡的裁定链接给对方观看。", null),
  指令_查卡图(2012, "宣言1个卡名才能发动。把百鸽数据库中1张宣言的卡的卡图链接给对方观看。", null),
